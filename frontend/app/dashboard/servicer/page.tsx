        ...
        <div className="space-y-8 animate-fade-in pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all">
                    ...
                    <p className="text-3xl font-black text-[#000000] tracking-tight">$4,280.00</p>
                    <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest mt-1">Earnings This Week</p>
                </div>
                ...
                <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all">
                    ...
                    <p className="text-3xl font-black text-[#000000] tracking-tight">4.92</p>
                            ...
                            <div key={job.id} className="px-10 py-8 hover:bg-slate-50/80 transition-all cursor-pointer group flex items-center justify-between">
                                <div className="flex items-center gap-8">
                                    ...
                                    <div className="space-y-1.5">
                                        <h4 className="text-lg font-black text-[#000000] tracking-tight group-hover:text-[#064e3b] transition-colors uppercase">{job.title}</h4>
                                        <div className="flex items-center gap-5 text-[10px] font-black text-slate-600 uppercase tracking-widest">
                                            <span className="flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5" /> Unit {job.id * 105} - Block B</span>
                                            <span className="flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5" /> Due {job.due_date}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-10">
                                    <div className="text-right hidden md:block">
                                        ...
                                        <p className="text-sm font-black text-[#000000] uppercase">$240.00</p>
                                    </div>
