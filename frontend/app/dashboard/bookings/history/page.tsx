                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-8">
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    <p className="text-xs font-bold text-slate-500 flex items-center gap-4">
                                        ...
                                        <span className="flex items-center gap-1.5 font-black uppercase text-emerald-600 tracking-widest">{booking.provider?.company_name}</span>
                                    </p>
                                </div>
                                ...
                                <div className="flex items-center gap-10">
                                    <div className="text-right hidden lg:block">
                                        ...
                                        <p className="text-xl font-black text-slate-900 tracking-tighter">${booking.estimated_cost.toFixed(2)}</p>
                                    </div>
                                    <div className="flex items-center gap-3">
