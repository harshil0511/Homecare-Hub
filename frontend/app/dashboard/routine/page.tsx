...
function RoutineServiceContent() {
    ...
    // Phase state
    const [phase, setPhase] = useState<"form" | "providers">("form");
    ...
    const handleAssign = async (providerId: number) => {
        ...
        try {
            ...
            await fetchPendingTasks(); // refresh pending list
            setTimeout(() => {
    ...
    if (assignSuccess) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-in">
                ...
                <h2 className="text-2xl font-black text-[#000000] tracking-tight uppercase">Expert Assigned</h2>
                <p className="text-sm text-slate-500 mt-2 font-bold">Redirecting to Operations...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-4">
                ...
                {phase === "providers" && (
                    <button
                        onClick={() => { setPhase("form"); setProviders([]); setCreatedTask(null); }}
                                ...
                                {providers.map(provider => (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all active:scale-95 bg-[#064e3b] text-white hover:bg-emerald-950 disabled:opacity-60 disabled:cursor-not-allowed shadow-lg shadow-emerald-900/10"
                                        >
                                            ...
                                            {assigning === provider.id ? "Assigning..." : "Select Expert"}
                                            {assigning !== provider.id && <ChevronRight className="w-3.5 h-3.5" />}
                                        </button>
                                    </div>
                                ))}
                            </div>
