...
import { User, Shield, CheckCircle2, AlertCircle, Building2 } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto py-12">
            <div className="bg-white border border-slate-200 rounded-[2rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-lg font-black text-[#000000] uppercase tracking-tight">Secretary Profile</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-amber-50 text-amber-700 border-amber-200">
