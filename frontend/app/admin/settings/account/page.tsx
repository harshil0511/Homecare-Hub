        ...
        <div className="max-w-2xl mx-auto animate-fade-in py-12">
            <div className="bg-white border border-slate-200 rounded-[2rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-lg font-black text-[#000000] uppercase tracking-tight">Admin Account</h2>
                </div>
                ...
                <div className="space-y-5 mb-8">
                    <div className="flex items-center justify-between py-3 px-2 border-b border-slate-50">
                        ...
                        <span className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-purple-700">
                    ...
                    <div className="flex items-center justify-between py-3 px-2 border-b border-slate-50">
                        <span className="text-[10px] font-black text-slate-600 uppercase tracking-[0.2em]">Admin ID</span>
