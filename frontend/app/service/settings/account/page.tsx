...
import { Briefcase, LogOut, Copy, Check } from "lucide-react";

export default function ServicerAccountPage() {
        ...
        <div className="max-w-2xl mx-auto animate-fade-in py-12">
            <div className="bg-white border border-slate-200 rounded-[2rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h2 className="text-lg font-black text-[#000000] uppercase tracking-tight">Servicer Account</h2>
                </div>
