...
import { User, Wrench, Mail, Lock, UserPlus, CheckCircle, X, AlertCircle, ChevronDown } from "lucide-react";

const ROLES = [
    {
        value: "USER",
        label: "Home User",
        description: "Book and manage homecare services",
        icon: User,
    },
    {
        value: "SERVICER",
        label: "Servicer",
        description: "Offer and manage homecare jobs",
        icon: Wrench,
    },
];
...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            {/* Toast Popup */}
            {toast && (
                <div className={`fixed top-6 right-6 z-[9999] max-w-sm w-full animate-in slide-in-from-top-3 fade-in duration-300 shadow-2xl rounded-2xl border p-4 flex items-start gap-3 ${toast.type === "error"
            ...
            <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl shadow-lg p-10">
                ...
                {/* Role Selection - Consolidate into a Premium Dropdown */}
                <div className="mb-7">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                {error.toLowerCase().includes("already exists") && (
                                    <Link href="/login" className="inline-block mt-2 text-emerald-700 font-bold hover:underline text-xs">
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1.5 ml-1">
                            Must have 6+ chars, 1 uppercase &amp; 1 special character (@#$!%*?&amp;)
                        </p>
                    </div>
