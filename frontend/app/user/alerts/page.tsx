                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-0.5">
                                                    ...
                                                    {booking.priority === "Emergency" && (
                                                        <span className="text-[10px] font-black px-1.5 py-0.5 rounded bg-red-50 text-red-700 uppercase tracking-widest flex-shrink-0">Emergency</span>
                                                    )}
                                                </div>
                                                ...
                                                {loadingDetail ? (
                                                    ...
                                                    <div className="max-h-[360px] overflow-y-auto space-y-4 pr-2">
                                                        <div className="flex items-center gap-3 flex-wrap">
                                                            <span className="text-[10px] font-black bg-amber-100 text-amber-700 px-2.5 py-1 rounded uppercase tracking-widest">{bookingDetail.status}</span>
                                                            <span className="text-[10px] font-black bg-slate-100 text-slate-500 px-2.5 py-1 rounded uppercase tracking-widest">ID: #{bookingDetail.id?.toString().padStart(5, "0")}</span>
                                                        </div>
