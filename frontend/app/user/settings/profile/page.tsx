...
export default function ProfilePage() {
    ...
    const roleBadge = (r: string) => {
        const colors: Record<string, string> = {
            ...
            SERVICER: "bg-emerald-50 text-emerald-700 border-emerald-200",
            USER: "bg-blue-50 text-blue-700 border-blue-200",
        };
        return colors[r] || colors.USER;
    };
        ...
        <div className="max-w-2xl mx-auto py-12">
            <div className="bg-white border border-slate-200 rounded-[2rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-3">
                        <label className="block text-[10px] font-black text-slate-600 uppercase tracking-[0.2em] ml-1">Account Role</label>
                        <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border ${roleBadge(role)}`}>
